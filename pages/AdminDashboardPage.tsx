                ...
                <header className="bg-white shadow-sm z-10">
                    <div className="max-w-full mx-auto py-4 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
                        <div className="flex items-center">
                             <button 
                                className="text-gray-500 focus:outline-none md:hidden p-1 mr-2 rounded-md hover:bg-gray-100 focus:ring-2 focus:ring-brand-blue transition-colors" 
                            ...
                            <h1 className="text-xl md:text-2xl font-bold text-brand-dark">Admin Dashboard</h1>
                        </div>
                        <button
